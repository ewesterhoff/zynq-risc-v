...
module sd_file_reader #(
    parameter            FILE_NAME_LEN = 14         , // length of FILE_NAME (in bytes). Since the length of "example.txt" is 11, so here is 11.
    parameter [52*8-1:0] FILE_NAME     = "my_program.mem", // file name to read, ignore upper and lower case
    ...
    parameter      [2:0] CLK_DIV       = 3'd2,          // when clk =   0~ 25MHz , set CLK_DIV = 3'd1,
                                                        ...
                                                        // ......
    parameter            SIMULATE      = 1              // 0:normal use.         1:only for simulation
) (

 ...
 *  \version 9.4.2
 *  \brief   Contains module definition of the 'ecen5593_startercode_ca' ASIP.
 */

module ecen5593_startercode_ca(
    input  wire CLK,
    input  wire RST,
    ...
    ecen5593_startercode_ca_if_code_t if_code (
    ...
    // CodAL interface instance:
    ecen5593_startercode_ca_ldst_t ldst (
    ...
    // ASIP core instance:
    ecen5593_startercode_ca_core_t core (
        .CLK(CLK),
        .RST(RST),
...
endmodule // ecen5593_startercode_ca

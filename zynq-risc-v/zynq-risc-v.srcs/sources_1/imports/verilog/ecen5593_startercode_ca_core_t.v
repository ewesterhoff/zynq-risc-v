...
module ecen5593_startercode_ca_core_t(
    input  wire CLK,
    input  wire RST,
    ...
    wire s_id_regwrite;
    // CodAL signal/wire
    wire [1:0] s_id_rfwtsel;
    // CodAL signal/wire
    wire [2:0] s_id_brnchop;
    // CodAL signal/wire
    wire s_id_brnchsel;
    // CodAL signal/wire
    wire [3:0] s_id_memop;
    ...
    // CodAL signal/wire
    wire [31:0] s_id_immedi;
    // CodAL signal/wire
    wire [31:0] s_id_immedb;
    // CodAL signal/wire
    wire [31:0] s_id_immedu;
    // CodAL signal/wire
    wire [31:0] s_id_immeds;
    // CodAL signal/wire
    wire [31:0] s_id_immedj;
    // CodAL signal/wire
    wire [31:0] s_id_reg1;
    // CodAL signal/wire
    wire [31:0] s_id_reg2;
    ...
    wire id_output_r_ex_rfwtsel_WE_wire;
    wire [1:0] id_output_r_ex_rfwtsel_D_wire;
    wire [1:0] r_ex_rfwtsel_Q_wire;
    wire id_output_r_ex_brnchop_WE_wire;
    wire [2:0] id_output_r_ex_brnchop_D_wire;
    wire [2:0] r_ex_brnchop_Q_wire;
    wire id_output_r_ex_brnchsel_WE_wire;
    wire id_output_r_ex_brnchsel_D_wire;
    wire r_ex_brnchsel_Q_wire;
    ...
    wire ex_output_r_me_rfwtsel_WE_wire;
    wire [1:0] ex_output_r_me_rfwtsel_D_wire;
    wire [1:0] r_me_rfwtsel_Q_wire;
    ...
    wire ex_output_r_me_brnchop_WE_wire;
    wire [2:0] ex_output_r_me_brnchop_D_wire;
    wire [2:0] r_me_brnchop_Q_wire;
    ...
    wire me_output_r_wb_rfwtsel_WE_wire;
    wire [1:0] me_output_r_wb_rfwtsel_D_wire;
    wire [1:0] r_wb_rfwtsel_Q_wire;
    ...
    d_ff_rst_we_stall_clr_t #(
        ...
        .CLEAR(pipe_EX_CLEAR_Q_wire),
        .STALL(pipe_EX_STALL_Q_wire),
        .WE(id_output_r_ex_rfwtsel_WE_wire),
        .D(id_output_r_ex_rfwtsel_D_wire),
        .Q(r_ex_rfwtsel_Q_wire)
    );
    ...
    d_ff_rst_we_stall_clr_t #(
        ...
        .CLEAR(pipe_EX_CLEAR_Q_wire),
        .STALL(pipe_EX_STALL_Q_wire),
        .WE(id_output_r_ex_brnchop_WE_wire),
        .D(id_output_r_ex_brnchop_D_wire),
        .Q(r_ex_brnchop_Q_wire)
    );
    ...
    d_ff_rst_we_stall_clr_t #(
        ...
        .CLEAR(pipe_EX_CLEAR_Q_wire),
        .STALL(pipe_EX_STALL_Q_wire),
        .WE(id_output_r_ex_brnchsel_WE_wire),
        .D(id_output_r_ex_brnchsel_D_wire),
        .Q(r_ex_brnchsel_Q_wire)
    );
    ...
    d_ff_rst_we_stall_clr_t #(
        ...
        .CLEAR(pipe_ME_CLEAR_Q_wire),
        .STALL(pipe_ME_STALL_Q_wire),
        .WE(ex_output_r_me_rfwtsel_WE_wire),
        .D(ex_output_r_me_rfwtsel_D_wire),
        .Q(r_me_rfwtsel_Q_wire)
    );
    ...
    d_ff_rst_we_stall_clr_t #(
        ...
        .CLEAR(pipe_ME_CLEAR_Q_wire),
        .STALL(pipe_ME_STALL_Q_wire),
        .WE(ex_output_r_me_brnchop_WE_wire),
        .D(ex_output_r_me_brnchop_D_wire),
        .Q(r_me_brnchop_Q_wire)
    );
    ...
    d_ff_rst_we_stall_clr_t #(
        ...
        .CLEAR(pipe_WB_CLEAR_Q_wire),
        .STALL(pipe_WB_STALL_Q_wire),
        .WE(me_output_r_wb_rfwtsel_WE_wire),
        .D(me_output_r_wb_rfwtsel_D_wire),
        .Q(r_wb_rfwtsel_Q_wire)
    );
    ...
    ecen5593_startercode_ca_core_rf_xpr_t rf_xpr (
        .CLK(CLK),
        .RST(RST),
    ...
    ecen5593_startercode_ca_core_pipeline_control_t pipeline_control (
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_wb_t wb (
        ...
        .r_wb_rfwtsel_Q(r_wb_rfwtsel_Q_wire),
        .s_wb_pc4_Q(s_wb_pc4),
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_reset_t reset (
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_ex_memory_t ex_memory (
        .ACT(ex_ex_memory_ACT_wire),
        .r_ex_memop_Q(r_ex_memop_Q_wire),
        .s_ex_alu_Q(s_ex_alu),
        .s_ex_fwd2_Q(s_ex_fwd2),
        ...
        .s_ex_encoded_data_D(s_ex_encoded_data),
        .s_ex_memsize_D(s_ex_memsize)
    );

    // functional unit instance:
    ecen5593_startercode_ca_core_ex_output_t ex_output (
        .ACT(ex_ex_output_ACT_wire),
        .r_ex_brnchop_Q(r_ex_brnchop_Q_wire),
        .r_ex_memop_Q(r_ex_memop_Q_wire),
        .r_ex_pc_Q(r_ex_pc_Q_wire),
        .r_ex_rd_Q(r_ex_rd_Q_wire),
        .r_ex_regwrite_Q(r_ex_regwrite_Q_wire),
        .r_ex_rfwtsel_Q(r_ex_rfwtsel_Q_wire),
        .s_ex_alu_Q(s_ex_alu),
        .s_ex_bradd_Q(s_ex_bradd),
        .s_ex_encoded_data_Q(s_ex_encoded_data),
        ...
        .r_me_brnchop_D(ex_output_r_me_brnchop_D_wire),
        .r_me_brnchop_WE(ex_output_r_me_brnchop_WE_wire),
        ...
        .r_me_rfwtsel_D(ex_output_r_me_rfwtsel_D_wire),
        .r_me_rfwtsel_WE(ex_output_r_me_rfwtsel_WE_wire),
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_id_output_t id_output (
        ...
        .s_id_brnchop_Q(s_id_brnchop),
        .s_id_brnchsel_Q(s_id_brnchsel),
        ...
        .r_ex_brnchop_D(id_output_r_ex_brnchop_D_wire),
        .r_ex_brnchop_WE(id_output_r_ex_brnchop_WE_wire),
        .r_ex_brnchsel_D(id_output_r_ex_brnchsel_D_wire),
        .r_ex_brnchsel_WE(id_output_r_ex_brnchsel_WE_wire),
        ...
        .r_ex_rfwtsel_D(id_output_r_ex_rfwtsel_D_wire),
        .r_ex_rfwtsel_WE(id_output_r_ex_rfwtsel_WE_wire),
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_if_output_t if_output (
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_me_memory_t me_memory (
        ...
        .s_me_decoded_data_Q(s_me_decoded_data),
        .s_wb_stall_Q(s_wb_stall),
        .ldst_HWDATA(ldst_HWDATA),
        .s_me_decoded_data_D(s_me_decoded_data),
        .s_me_mem_result_D(s_me_mem_result),
        .s_me_stall_D(s_me_stall)
    );

    // functional unit instance:
    ecen5593_startercode_ca_core_me_output_t me_output (
        ...
        .r_me_rfwtsel_Q(r_me_rfwtsel_Q_wire),
        .s_me_mem_result_Q(s_me_mem_result),
        ...
        .r_wb_rfwtsel_D(me_output_r_wb_rfwtsel_D_wire),
        .r_wb_rfwtsel_WE(me_output_r_wb_rfwtsel_WE_wire)
    );

    // functional unit instance:
    ecen5593_startercode_ca_core_ex_t ex (
        .ACT(main_ex_ACT_wire),
        .r_ex_aluop_Q(r_ex_aluop_Q_wire),
        .r_ex_alusrc1_Q(r_ex_alusrc1_Q_wire),
        .r_ex_alusrc2_Q(r_ex_alusrc2_Q_wire),
        .r_ex_brnchop_Q(r_ex_brnchop_Q_wire),
        .r_ex_brnchsel_Q(r_ex_brnchsel_Q_wire),
        ...
        .s_ex_fast_zero_Q(s_ex_fast_zero),
        .s_ex_fwd1_Q(s_ex_fwd1),
        .s_ex_fwd2_Q(s_ex_fwd2),
        .s_ex_fwdA_Q(s_ex_fwdA),
        .s_ex_fwdB_Q(s_ex_fwdB),
        ...
        .s_ex_fast_zero_D(s_ex_fast_zero),
        .s_ex_fwd1_D(s_ex_fwd1),
        .s_ex_fwd2_D(s_ex_fwd2),
        .s_ex_fwdA_D(s_ex_fwdA),
        .s_ex_fwdB_D(s_ex_fwdB),
        .s_ex_src1_D(s_ex_src1),
        .s_ex_src2_D(s_ex_src2),
        .s_ex_stall_D(s_ex_stall),
        .s_ex_take_branch_D(s_ex_take_branch),
        .s_ex_zero_D(s_ex_zero)
    );

    // functional unit instance:
    ecen5593_startercode_ca_core_fe_t fe (
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_id_t id (
        ...
        .s_ex_stall_Q(s_ex_stall),
        .s_id_fwdA_Q(s_id_fwdA),
        .s_id_fwdB_Q(s_id_fwdB),
        ...
        .s_id_fwdA_D(s_id_fwdA),
        .s_id_fwdB_D(s_id_fwdB),
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_me_t me (
        .ACT(main_me_ACT_wire),
        .r_me_brnchop_Q(r_me_brnchop_Q_wire),
    ...
    // functional unit instance:
    ecen5593_startercode_ca_core_main_t main (
    ...
    ecen5593_startercode_ca_core_codasip_startup_ctrl_t codasip_startup_ctrl (
        .CLK(CLK),
        .RST(RST),
...
endmodule // ecen5593_startercode_ca_core_t

...
module ecen5593_startercode_ca_core_fe_t(
    ...
    // signal/wire
    wire [31:0] STATEMENT_BIT_CONCATENATE_86_STATEMENT_AST_10_wire;
    // signal/wire
    ...
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:58:18
    // codasip_tmp_var_2.write((uint1)(s_interrupt.read()));
    assign codasip_tmp_var_2 = ((!codasip_tmp_var_1) && (!codasip_tmp_var_0)) ? s_interrupt_Q : 1'b0;
    ...
    assign s_if_pcin_D_ACT_wire =
        ...
        // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:59:13
        // s_if_pcin.write((int32)(0x1058));
        codasip_tmp_var_2 ? 32'h00001058 :
        // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:62:13
        // s_if_pcin.write(r_pc.read());
        r_pc_Q;
    assign STATEMENT_BIT_CONCATENATE_86_STATEMENT_AST_10_wire = {s_if_pcin_Q[31:2], 2'h0};
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:68:9
    // if_code.transport((uint3)(0x0), (uint2)(0x2), (uint1)(0x0), s_if_pcin.read()[31 .. 2] :: (uin ...
    assign if_code_HADDR = STATEMENT_BIT_CONCATENATE_86_STATEMENT_AST_10_wire;
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:68:9
    // if_code.transport((uint3)(0x0), (uint2)(0x2), (uint1)(0x0), s_if_pcin.read()[31 .. 2] :: (uin ...
    ...
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:83:18
    // if_output();
    assign if_output_ACT = (ACT == 1'b1) ? 1'b1 : 1'b0;
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:77:9
    // s_ex_clear.write((s_me_pcsrc.read() || s_ex_take_branch.read() || s_id_stall.read() || s_inte ...
    assign s_ex_clear_D = (ACT == 1'b1) ? (((s_me_pcsrc_Q || s_ex_take_branch_Q) || s_id_stall_Q) || s_interrupt_Q) : 1'b0;
    ...
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:73:9
    ...
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:80:9
    // s_me_clear.write(s_me_pcsrc.read());
    assign s_me_clear_D = (ACT == 1'b1) ? s_me_pcsrc_Q : 1'b0;
    // /home/project/ecen5593-startercode/model/ca/pipelines/ca_pipe1_if.codal:78:9

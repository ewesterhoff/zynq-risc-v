...
create_clock -add -name sys_clk_pin -period 12.00 -waveform {0 6} [get_ports { sysclk }];
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { r_btn }]; #IO_L7P_T1_34 Sch=btn[3]
